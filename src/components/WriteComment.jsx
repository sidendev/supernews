...
const WriteComment = (props) => {
  ...
  const handleSubmitComment = (event) => {
    ...
    postNewComment(article_id, commentAuthor, commentBody)
    setCommentBody('')
    setThanksMessage(true)
    props.setCommentsUpdated(true)
  }
  ...
  return (
    <section className="container flex flex-col max-w-2xl px-6 py-2 mx-auto space-y-12 divide-gray-300 bg-gray-100 text-gray-900">
      <div>
        <textarea type='text' id="commentBody" placeholder="Write your comment here..."
          className="textarea textarea-bordered w-full max-w-xs"
          onChange={handleChangeCommentBody} value={commentBody}></textarea><br />
        <button type="submit" onClick={handleSubmitComment} className="btn btn-sm bg-red-600 text-white hover:bg-red-700">Post Comment</button>
